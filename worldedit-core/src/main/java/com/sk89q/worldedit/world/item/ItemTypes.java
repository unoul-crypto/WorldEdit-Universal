...
public final class ItemTypes {
    ...
    @Nullable public static final ItemType ACACIA_SHELF = get("minecraft:acacia_shelf");
    ...
    @Nullable public static final ItemType ARMADILLO_SCUTE = get("minecraft:armadillo_scute");
    @Nullable public static final ItemType ARMADILLO_SPAWN_EGG = get("minecraft:armadillo_spawn_egg");
    ...
    @Nullable public static final ItemType BAMBOO_SHELF = get("minecraft:bamboo_shelf");
    ...
    @Nullable public static final ItemType BIRCH_SHELF = get("minecraft:birch_shelf");
    ...
    @Nullable public static final ItemType BOGGED_SPAWN_EGG = get("minecraft:bogged_spawn_egg");
    @Nullable public static final ItemType BOLT_ARMOR_TRIM_SMITHING_TEMPLATE = get("minecraft:bolt_armor_trim_smithing_template");
    ...
    @Nullable public static final ItemType BREEZE_ROD = get("minecraft:breeze_rod");
    ...
    @Deprecated @Nullable public static final ItemType CHAIN = get("minecraft:chain");
    ...
    @Nullable public static final ItemType CHERRY_SHELF = get("minecraft:cherry_shelf");
    ...
    @Nullable public static final ItemType CHISELED_CINNABAR = get("minecraft:chiseled_cinnabar");
    ...
    @Nullable public static final ItemType CHISELED_SULFUR = get("minecraft:chiseled_sulfur");
    ...
    @Nullable public static final ItemType CINNABAR = get("minecraft:cinnabar");
    @Nullable public static final ItemType CINNABAR_BRICK_SLAB = get("minecraft:cinnabar_brick_slab");
    @Nullable public static final ItemType CINNABAR_BRICK_STAIRS = get("minecraft:cinnabar_brick_stairs");
    @Nullable public static final ItemType CINNABAR_BRICK_WALL = get("minecraft:cinnabar_brick_wall");
    @Nullable public static final ItemType CINNABAR_BRICKS = get("minecraft:cinnabar_bricks");
    @Nullable public static final ItemType CINNABAR_SLAB = get("minecraft:cinnabar_slab");
    @Nullable public static final ItemType CINNABAR_STAIRS = get("minecraft:cinnabar_stairs");
    @Nullable public static final ItemType CINNABAR_WALL = get("minecraft:cinnabar_wall");
    ...
    @Nullable public static final ItemType COPPER_AXE = get("minecraft:copper_axe");
    @Nullable public static final ItemType COPPER_BARS = get("minecraft:copper_bars");
    @Nullable public static final ItemType COPPER_BLOCK = get("minecraft:copper_block");
    @Nullable public static final ItemType COPPER_BOOTS = get("minecraft:copper_boots");
    @Nullable public static final ItemType COPPER_BULB = get("minecraft:copper_bulb");
    @Nullable public static final ItemType COPPER_CHAIN = get("minecraft:copper_chain");
    @Nullable public static final ItemType COPPER_CHEST = get("minecraft:copper_chest");
    @Nullable public static final ItemType COPPER_CHESTPLATE = get("minecraft:copper_chestplate");
    @Nullable public static final ItemType COPPER_DOOR = get("minecraft:copper_door");
    @Nullable public static final ItemType COPPER_GOLEM_SPAWN_EGG = get("minecraft:copper_golem_spawn_egg");
    @Nullable public static final ItemType COPPER_GOLEM_STATUE = get("minecraft:copper_golem_statue");
    @Nullable public static final ItemType COPPER_GRATE = get("minecraft:copper_grate");
    @Nullable public static final ItemType COPPER_HELMET = get("minecraft:copper_helmet");
    @Nullable public static final ItemType COPPER_HOE = get("minecraft:copper_hoe");
    @Nullable public static final ItemType COPPER_HORSE_ARMOR = get("minecraft:copper_horse_armor");
    ...
    @Nullable public static final ItemType CRIMSON_SHELF = get("minecraft:crimson_shelf");
    ...
    @Nullable public static final ItemType DARK_OAK_SHELF = get("minecraft:dark_oak_shelf");
    ...
    @Nullable public static final ItemType EXPOSED_COPPER_BARS = get("minecraft:exposed_copper_bars");
    @Nullable public static final ItemType EXPOSED_COPPER_BULB = get("minecraft:exposed_copper_bulb");
    @Nullable public static final ItemType EXPOSED_COPPER_CHAIN = get("minecraft:exposed_copper_chain");
    @Nullable public static final ItemType EXPOSED_COPPER_CHEST = get("minecraft:exposed_copper_chest");
    @Nullable public static final ItemType EXPOSED_COPPER_DOOR = get("minecraft:exposed_copper_door");
    @Nullable public static final ItemType EXPOSED_COPPER_GOLEM_STATUE = get("minecraft:exposed_copper_golem_statue");
    @Nullable public static final ItemType EXPOSED_COPPER_GRATE = get("minecraft:exposed_copper_grate");
    @Nullable public static final ItemType EXPOSED_COPPER_LANTERN = get("minecraft:exposed_copper_lantern");
    ...
    @Nullable public static final ItemType EXPOSED_LIGHTNING_ROD = get("minecraft:exposed_lightning_rod");
    ...
    @Nullable public static final ItemType FLOW_ARMOR_TRIM_SMITHING_TEMPLATE = get("minecraft:flow_armor_trim_smithing_template");
    @Nullable public static final ItemType FLOW_BANNER_PATTERN = get("minecraft:flow_banner_pattern");
    @Nullable public static final ItemType FLOW_POTTERY_SHERD = get("minecraft:flow_pottery_sherd");
    ...
    @Nullable public static final ItemType HEAVY_CORE = get("minecraft:heavy_core");
    ...
    @Nullable public static final ItemType IRON_CHAIN = get("minecraft:iron_chain");
    ...
    @Nullable public static final ItemType JUNGLE_SHELF = get("minecraft:jungle_shelf");
    ...
    @Nullable public static final ItemType MANGROVE_SHELF = get("minecraft:mangrove_shelf");
    ...
    @Nullable public static final ItemType MUSIC_DISC_BOUNCE = get("minecraft:music_disc_bounce");
    ...
    @Nullable public static final ItemType OAK_SHELF = get("minecraft:oak_shelf");
    ...
    @Nullable public static final ItemType OXIDIZED_COPPER_BARS = get("minecraft:oxidized_copper_bars");
    @Nullable public static final ItemType OXIDIZED_COPPER_BULB = get("minecraft:oxidized_copper_bulb");
    @Nullable public static final ItemType OXIDIZED_COPPER_CHAIN = get("minecraft:oxidized_copper_chain");
    @Nullable public static final ItemType OXIDIZED_COPPER_CHEST = get("minecraft:oxidized_copper_chest");
    @Nullable public static final ItemType OXIDIZED_COPPER_DOOR = get("minecraft:oxidized_copper_door");
    @Nullable public static final ItemType OXIDIZED_COPPER_GOLEM_STATUE = get("minecraft:oxidized_copper_golem_statue");
    @Nullable public static final ItemType OXIDIZED_COPPER_GRATE = get("minecraft:oxidized_copper_grate");
    @Nullable public static final ItemType OXIDIZED_COPPER_LANTERN = get("minecraft:oxidized_copper_lantern");
    ...
    @Nullable public static final ItemType OXIDIZED_LIGHTNING_ROD = get("minecraft:oxidized_lightning_rod");
    ...
    @Nullable public static final ItemType PALE_OAK_SHELF = get("minecraft:pale_oak_shelf");
    ...
    @Nullable public static final ItemType POLISHED_CINNABAR = get("minecraft:polished_cinnabar");
    @Nullable public static final ItemType POLISHED_CINNABAR_SLAB = get("minecraft:polished_cinnabar_slab");
    @Nullable public static final ItemType POLISHED_CINNABAR_STAIRS = get("minecraft:polished_cinnabar_stairs");
    @Nullable public static final ItemType POLISHED_CINNABAR_WALL = get("minecraft:polished_cinnabar_wall");
    ...
    @Nullable public static final ItemType POLISHED_SULFUR = get("minecraft:polished_sulfur");
    @Nullable public static final ItemType POLISHED_SULFUR_SLAB = get("minecraft:polished_sulfur_slab");
    @Nullable public static final ItemType POLISHED_SULFUR_STAIRS = get("minecraft:polished_sulfur_stairs");
    @Nullable public static final ItemType POLISHED_SULFUR_WALL = get("minecraft:polished_sulfur_wall");
    ...
    @Nullable public static final ItemType POTENT_SULFUR = get("minecraft:potent_sulfur");
    ...
    @Nullable public static final ItemType SCRAPE_POTTERY_SHERD = get("minecraft:scrape_pottery_sherd");
    ...
    @Deprecated @Nullable public static final ItemType SCUTE = get("minecraft:scute");
    ...
    @Nullable public static final ItemType SPRUCE_SHELF = get("minecraft:spruce_shelf");
    ...
    @Nullable public static final ItemType SULFUR = get("minecraft:sulfur");
    @Nullable public static final ItemType SULFUR_BRICK_SLAB = get("minecraft:sulfur_brick_slab");
    @Nullable public static final ItemType SULFUR_BRICK_STAIRS = get("minecraft:sulfur_brick_stairs");
    @Nullable public static final ItemType SULFUR_BRICK_WALL = get("minecraft:sulfur_brick_wall");
    @Nullable public static final ItemType SULFUR_BRICKS = get("minecraft:sulfur_bricks");
    @Nullable public static final ItemType SULFUR_CUBE_BUCKET = get("minecraft:sulfur_cube_bucket");
    @Nullable public static final ItemType SULFUR_CUBE_SPAWN_EGG = get("minecraft:sulfur_cube_spawn_egg");
    @Nullable public static final ItemType SULFUR_SLAB = get("minecraft:sulfur_slab");
    @Nullable public static final ItemType SULFUR_SPIKE = get("minecraft:sulfur_spike");
    @Nullable public static final ItemType SULFUR_STAIRS = get("minecraft:sulfur_stairs");
    @Nullable public static final ItemType SULFUR_WALL = get("minecraft:sulfur_wall");
    ...
    @Nullable public static final ItemType TURTLE_SCUTE = get("minecraft:turtle_scute");
    ...
    @Nullable public static final ItemType VAULT = get("minecraft:vault");
    ...
    @Nullable public static final ItemType WARPED_SHELF = get("minecraft:warped_shelf");
    ...
    @Nullable public static final ItemType WAXED_COPPER_BARS = get("minecraft:waxed_copper_bars");
    ...
    @Nullable public static final ItemType WAXED_COPPER_CHAIN = get("minecraft:waxed_copper_chain");
    @Nullable public static final ItemType WAXED_COPPER_CHEST = get("minecraft:waxed_copper_chest");
    @Nullable public static final ItemType WAXED_COPPER_DOOR = get("minecraft:waxed_copper_door");
    @Nullable public static final ItemType WAXED_COPPER_GOLEM_STATUE = get("minecraft:waxed_copper_golem_statue");
    @Nullable public static final ItemType WAXED_COPPER_GRATE = get("minecraft:waxed_copper_grate");
    @Nullable public static final ItemType WAXED_COPPER_LANTERN = get("minecraft:waxed_copper_lantern");
    ...
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_BARS = get("minecraft:waxed_exposed_copper_bars");
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_BULB = get("minecraft:waxed_exposed_copper_bulb");
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_CHAIN = get("minecraft:waxed_exposed_copper_chain");
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_CHEST = get("minecraft:waxed_exposed_copper_chest");
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_DOOR = get("minecraft:waxed_exposed_copper_door");
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_GOLEM_STATUE = get("minecraft:waxed_exposed_copper_golem_statue");
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_GRATE = get("minecraft:waxed_exposed_copper_grate");
    @Nullable public static final ItemType WAXED_EXPOSED_COPPER_LANTERN = get("minecraft:waxed_exposed_copper_lantern");
    ...
    @Nullable public static final ItemType WAXED_EXPOSED_LIGHTNING_ROD = get("minecraft:waxed_exposed_lightning_rod");
    @Nullable public static final ItemType WAXED_LIGHTNING_ROD = get("minecraft:waxed_lightning_rod");
    ...
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_BARS = get("minecraft:waxed_oxidized_copper_bars");
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_BULB = get("minecraft:waxed_oxidized_copper_bulb");
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_CHAIN = get("minecraft:waxed_oxidized_copper_chain");
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_CHEST = get("minecraft:waxed_oxidized_copper_chest");
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_DOOR = get("minecraft:waxed_oxidized_copper_door");
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_GOLEM_STATUE = get("minecraft:waxed_oxidized_copper_golem_statue");
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_GRATE = get("minecraft:waxed_oxidized_copper_grate");
    @Nullable public static final ItemType WAXED_OXIDIZED_COPPER_LANTERN = get("minecraft:waxed_oxidized_copper_lantern");
    ...
    @Nullable public static final ItemType WAXED_OXIDIZED_LIGHTNING_ROD = get("minecraft:waxed_oxidized_lightning_rod");
    ...
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_BARS = get("minecraft:waxed_weathered_copper_bars");
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_BULB = get("minecraft:waxed_weathered_copper_bulb");
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_CHAIN = get("minecraft:waxed_weathered_copper_chain");
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_CHEST = get("minecraft:waxed_weathered_copper_chest");
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_DOOR = get("minecraft:waxed_weathered_copper_door");
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_GOLEM_STATUE = get("minecraft:waxed_weathered_copper_golem_statue");
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_GRATE = get("minecraft:waxed_weathered_copper_grate");
    @Nullable public static final ItemType WAXED_WEATHERED_COPPER_LANTERN = get("minecraft:waxed_weathered_copper_lantern");
    ...
    @Nullable public static final ItemType WAXED_WEATHERED_LIGHTNING_ROD = get("minecraft:waxed_weathered_lightning_rod");
    ...
    @Nullable public static final ItemType WEATHERED_COPPER_BARS = get("minecraft:weathered_copper_bars");
    @Nullable public static final ItemType WEATHERED_COPPER_BULB = get("minecraft:weathered_copper_bulb");
    @Nullable public static final ItemType WEATHERED_COPPER_CHAIN = get("minecraft:weathered_copper_chain");
    @Nullable public static final ItemType WEATHERED_COPPER_CHEST = get("minecraft:weathered_copper_chest");
    @Nullable public static final ItemType WEATHERED_COPPER_DOOR = get("minecraft:weathered_copper_door");
    @Nullable public static final ItemType WEATHERED_COPPER_GOLEM_STATUE = get("minecraft:weathered_copper_golem_statue");
    @Nullable public static final ItemType WEATHERED_COPPER_GRATE = get("minecraft:weathered_copper_grate");
    @Nullable public static final ItemType WEATHERED_COPPER_LANTERN = get("minecraft:weathered_copper_lantern");
    ...
    @Nullable public static final ItemType WEATHERED_LIGHTNING_ROD = get("minecraft:weathered_lightning_rod");
    ...
    @Nullable public static final ItemType WOLF_ARMOR = get("minecraft:wolf_armor");
